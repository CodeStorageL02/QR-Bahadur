...
def QR_Sum_Limit(limitL,limitR,file_name,lam=0.1,size=20):
    """
           :param limitL: 控制线下线
           :param limitR: 控制线上限
...
if __name__ == '__main__':
    file_name = "./QR_limit_t"
    size = 20
    lam_d = 0.1
    print(size)
    print(lam_d)
    with open(file_name + '.txt', 'a') as file:
        file.write("n=20 t-student \n")
    QR_Sum_Limit(limitL=0.01,limitR=3.28,file_name=file_name,lam=lam_d,size=size)
